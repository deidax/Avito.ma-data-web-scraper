    ...
    <div class="login">
      <div class="container">
        <div>
          ...
          <h1 style="text-align:center; font-weight: 300">Projet de fin d'étude</h1>
          <h3 style="text-align:center; font-weight: 300">Master Big Data ENSA de Kenitra</h3>
        </div>
...
.bg-illustration {
  ...
  height: 100vh;
  width: 1194px;
  background: url('~@/assets/backgound_img.jpg') no-repeat center center scroll;
